...
chose_character_1_state::~chose_character_1_state()
{
...
void chose_character_1_state::update(const float &dt)
{
...
void chose_character_1_state::render(sf::RenderTarget* target)
{
    if (!target) {
        target = this->window;
    }
...
void chose_character_1_state::update_input(const float &dt)
{
...
void chose_character_1_state::update_button()
{
...
void chose_character_1_state::render_button(sf::RenderTarget &target)
{
    for (auto it : this->buttons)
    {
...
void chose_character_1_state::init_key_binds()
{
    std::ifstream ifs;
...
void chose_character_1_state::init_font()
{
    if (!this->font.loadFromFile("fonts/Lato-Bold.ttf")) {
        throw("ERROR IN CHOSE_CHARACTER_1_STATE : can not load font");
    }
}

void chose_character_1_state::init_button()
{
    this->buttons["GAMEMODE_1_STATE"] = new gui::button(950.f, 200.f, 550.f, 150.f, &this->font,
        "NEW GAME 1", 25, sf::Color(70,70,70,200), sf::Color(150,150,150,200), sf::Color(20,20,20,200));

    this->buttons["CHOOSE_GAMEMODE_2_STATE"] = new gui::button(1820.f, 450.f, 100.f, 100.f, &this->font,
        ">", 25, sf::Color(70,70,70,200), sf::Color(150,150,150,200), sf::Color(20,20,20,200));

    this->buttons["CHOOSE_GAMEMODE_4_STATE"] = new gui::button(0.f, 450.f, 100.f, 100.f, &this->font,
        "<", 25, sf::Color(70,70,70,200), sf::Color(150,150,150,200), sf::Color(20,20,20,200));
